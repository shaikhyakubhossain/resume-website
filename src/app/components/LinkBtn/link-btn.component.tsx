...
export default function LinkBtn(props: propsType) {
  return (
    <button style={{borderColor: props.txtBorderIconColor, background:props.bgColor}} className={`flex mx-2 bg-transparent font-semibold py-2 px-4 border-2 hover:border-transparent rounded-full` + props.customTWStyle}>
